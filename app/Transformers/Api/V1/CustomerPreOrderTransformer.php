...
class CustomerPreOrderTransformer implements TransformerContract
{
    ...
    public static function toArray($customerPreOrder)
    {
        return [
            ...
            'fc_overdue' => $customerPreOrder->customerOrder->fc_overdue ?? null,
            'fc_comment' => $customerPreOrder->customerOrder->fc_comment ?? null,
            'fc_future_comment' => $customerPreOrder->customerOrder->fc_future_comment ?? null,
            'sent_at' => null,
            'customer_id' => $customerPreOrder->customer->getKey() ?? null,
            'status' => 'open',
