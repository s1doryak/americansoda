...
class SettingDataTable extends DataTable
{
	 ...
	 * @return array
	 */
	protected function getActions($setting)
	{
		//	return [
		//		'pdf' => [
		//          'resource' => $this->resource,
		//			'url' => route('{{namespace_snake_case}}.setting.pdf', $buildingApartment->getKey()),
		//			'target' => '_blank',
		//			'icon' => 'pdf',
		//			'color' => 'red',
		...
		return parent::getActions($setting);
	}
    ...
    protected function getButtons()
    {
        ...
        //		    'url' => route('{{namespace_snake_case}}.setting.go'),
        //		]
        //		[
        //          /**
        ...
        //			    'data-url' => route('{{namespace_snake_case}}.setting.create'),
        //			    'data-method' => 'GET',
