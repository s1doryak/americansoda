 ...
 */
class PaymentTypePolicy implements DatatablePolicyContract
{
     ...
     * @return boolean
     */
    public function view(Authenticatable $authenticatable, PaymentType $paymentType)
    {
     ...
     * @return boolean
     */
    public function update(Authenticatable $authenticatable, PaymentType $paymentType)
    {
     ...
     * @return boolean
     */
    public function trash(Authenticatable $authenticatable, PaymentType $paymentType)
    {
     ...
     * @return boolean
     */
    public function restore(Authenticatable $authenticatable, PaymentType $paymentType)
    {
     ...
     * @return boolean
     */
    public function destroy(Authenticatable $authenticatable, PaymentType $paymentType)
    {
