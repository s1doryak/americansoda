...
class PriceGroupPolicy implements DatatablePolicyContract
{
     ...
     * @return boolean
     */
    public function trash(Authenticatable $authenticatable, PriceGroup $priceGroup)
    {
     ...
     * @return boolean
     */
    public function destroy(Authenticatable $authenticatable, PriceGroup $priceGroup)
    {
