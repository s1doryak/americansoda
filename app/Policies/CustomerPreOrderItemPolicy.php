...
class CustomerPreOrderItemPolicy implements DatatablePolicyContract
{
     ...
     * @return boolean
     */
    public function trash(Authenticatable $authenticatable, CustomerPreOrderItem $customerPreOrderItem)
    {
     ...
     * @return boolean
     */
    public function destroy(Authenticatable $authenticatable, CustomerPreOrderItem $customerPreOrderItem)
    {
