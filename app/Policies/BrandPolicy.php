 ...
 */
class BrandPolicy implements DatatablePolicyContract
{
     ...
     * @return boolean
     */
    public function view(Authenticatable $authenticatable, Brand $brand)
    {
     ...
     * @return boolean
     */
    public function update(Authenticatable $authenticatable, Brand $brand)
    {
     ...
     * @return boolean
     */
    public function trash(Authenticatable $authenticatable, Brand $brand)
    {
     ...
     * @return boolean
     */
    public function restore(Authenticatable $authenticatable, Brand $brand)
    {
     ...
     * @return boolean
     */
    public function destroy(Authenticatable $authenticatable, Brand $brand)
    {
