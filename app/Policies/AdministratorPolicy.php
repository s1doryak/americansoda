...
class AdministratorPolicy implements DatatablePolicyContract
{
     ...
     * @return boolean
     */
    public function trash(Authenticatable $authenticatable, Administrator $administrator)
    {
     ...
     * @return boolean
     */
    public function destroy(Authenticatable $authenticatable, Administrator $administrator)
    {
