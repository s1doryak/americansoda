 ...
 */
class AuthLogPolicy implements DatatablePolicyContract
{
	 ...
	 * @return boolean
	 */
	public function view(Authenticatable $authenticatable, AuthLog $authLog)
	{
        switch (get_class($authenticatable)) {
	 ...
	 * @return boolean
	 */
	public function update(Authenticatable $authenticatable, AuthLog $authLog)
	{
        switch (get_class($authenticatable)) {
	 ...
	 * @return boolean
	 */
	public function trash(Authenticatable $authenticatable, AuthLog $authLog)
	{
        switch (get_class($authenticatable)) {
     ...
     * @return boolean
     */
    public function restore(Authenticatable $authenticatable, AuthLog $authLog)
    {
        switch (get_class($authenticatable)) {
     ...
     * @return boolean
     */
    public function destroy(Authenticatable $authenticatable, AuthLog $authLog)
    {
        switch (get_class($authenticatable)) {
    ...
    //   * @return boolean
    //   */
    //  public function pdf(Authenticatable $authenticatable, AuthLog $authLog)
    //  {
    //      return true;
    //  }
}
