...
class CustomerUserTokenPolicy implements DatatablePolicyContract
{
     ...
     * @return boolean
     */
    public function trash(Authenticatable $authenticatable, CustomerUserToken $customerUserToken)
    {
     ...
     * @return boolean
     */
    public function destroy(Authenticatable $authenticatable, CustomerUserToken $customerUserToken)
    {
