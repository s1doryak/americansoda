 ...
 */
class PackageTypePolicy implements DatatablePolicyContract
{
     ...
     * @return boolean
     */
    public function view(Authenticatable $authenticatable, PackageType $packageType)
    {
     ...
     * @return boolean
     */
    public function update(Authenticatable $authenticatable, PackageType $packageType)
    {
     ...
     * @return boolean
     */
    public function trash(Authenticatable $authenticatable, PackageType $packageType)
    {
     ...
     * @return boolean
     */
    public function restore(Authenticatable $authenticatable, PackageType $packageType)
    {
     ...
     * @return boolean
     */
    public function destroy(Authenticatable $authenticatable, PackageType $packageType)
    {
