 ...
 */
class ProductTagPolicy implements DatatablePolicyContract
{
     ...
     * @return boolean
     */
    public function view(Authenticatable $authenticatable, ProductTag $productTag)
    {
     ...
     * @return boolean
     */
    public function update(Authenticatable $authenticatable, ProductTag $productTag)
    {
     ...
     * @return boolean
     */
    public function trash(Authenticatable $authenticatable, ProductTag $productTag)
    {
     ...
     * @return boolean
     */
    public function restore(Authenticatable $authenticatable, ProductTag $productTag)
    {
     ...
     * @return boolean
     */
    public function destroy(Authenticatable $authenticatable, ProductTag $productTag)
    {
