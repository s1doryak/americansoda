 ...
 */
class CustomerPolicy implements DatatablePolicyContract
{
     ...
     * @return boolean
     */
    public function view(Authenticatable $authenticatable, Customer $customer)
    {
     ...
     * @return boolean
     */
    public function update(Authenticatable $authenticatable, Customer $customer)
    {
     ...
     * @return boolean
     */
    public function trash(Authenticatable $authenticatable, Customer $customer)
    {
     ...
     * @return boolean
     */
    public function restore(Authenticatable $authenticatable, Customer $customer)
    {
     ...
     * @return boolean
     */
    public function destroy(Authenticatable $authenticatable, Customer $customer)
    {
