 ...
 */
class SettingPolicy implements DatatablePolicyContract
{
	 ...
	 * @return boolean
	 */
	public function view(Authenticatable $authenticatable, Setting $setting)
	{
        switch (get_class($authenticatable)) {
	 ...
	 * @return boolean
	 */
	public function update(Authenticatable $authenticatable, Setting $setting)
	{
        switch (get_class($authenticatable)) {
	 ...
	 * @return boolean
	 */
	public function trash(Authenticatable $authenticatable, Setting $setting)
	{
        switch (get_class($authenticatable)) {
     ...
     * @return boolean
     */
    public function restore(Authenticatable $authenticatable, Setting $setting)
    {
        switch (get_class($authenticatable)) {
     ...
     * @return boolean
     */
    public function destroy(Authenticatable $authenticatable, Setting $setting)
    {
        switch (get_class($authenticatable)) {
    ...
    //   * @return boolean
    //   */
    //  public function pdf(Authenticatable $authenticatable, Setting $setting)
    //  {
    //      return true;
    //  }
}
