...
@section('content')
    ...
    <table class="table-50p3">
        ...
        <tr>
            ...
            <td class="number">{{ $shipment->order_numbers }}</td>
        </tr>
        <tr>
    ...
    <table class="products-table">
        ...
        <tr class="divider-thick">
            ...
            <td class="border-left">
                {!! auto_number_format($shipmentItems->sum(function($item){ return $item->product->brutto_weight * $item->packages_quantity;}), 2, ',', '&nbsp;') !!}
            </td>
            <td colspan="3" class="border-left"></td>
